...
const (
	ffjtErrorResponsebase = iota
	ffjtErrorResponsenosuchkey
...
func (j *ErrorResponse) UnmarshalJSONFFLexer(fs *fflib.FFLexer, state fflib.FFParseState) error {
	var err error
	currentKey := ffjtErrorResponsebase
	_ = currentKey
...
mainparse:
	for {
		...
		case fflib.FFParse_want_key:
			...
			if len(kn) <= 0 {
				// "" case. hrm.
				currentKey = ffjtErrorResponsenosuchkey
				...
				case 'm':
					...
					if bytes.Equal(ffjKeyErrorResponseMessage, kn) {
						currentKey = ffjtErrorResponseMessage
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				case 's':
					...
					if bytes.Equal(ffjKeyErrorResponseStatus, kn) {
						currentKey = ffjtErrorResponseStatus
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				if fflib.EqualFoldRight(ffjKeyErrorResponseMessage, kn) {
					currentKey = ffjtErrorResponseMessage
					state = fflib.FFParse_want_colon
					goto mainparse
				}
