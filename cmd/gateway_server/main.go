...
import (
	...
	"os-gateway/internal/pokt_client"
...
func main() {
	...
	relayController := controllers.NewRelayController(pokt_client.NewCachedClient(client), gatewayConfigProvider.GetAppStakes(), logger)
